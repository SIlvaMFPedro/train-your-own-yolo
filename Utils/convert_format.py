...
if __name__ == '__main__':
    ...
    multi_df = pd.read_csv(
        "C:/Users/pedro/Documents/Insight/eq/EQ_new/Train_Housing_detector/2/vott-csv-export/Housing_cropping-export.csv"
    )
    ...
    label_names = ["background", "facade", "molding", "cornice", "pillar", "window", "door", "sill", "blind",
                   "balcony", "shop", "deco"]
