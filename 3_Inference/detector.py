...
# Setup folder names for default values
...
model_classes = os.path.join(model_folder, "data_classes.txt.txt")
...
if __name__ == '__main__':
    # Construct the argument parser, parse the argument and delete all default flags
    ...
    parser.add_argument("--gpu_num", type=int, default=1, help="Number of GPU to use. Default is 1")
    ...
    parser.add_argument("--postfix", type=str, dest="postfix", default="_catface",
    ...
    # Split the images and the videos
    ...
    if input_image_paths:
        ...
        for i, img_path in enumerate(input_image_paths):
            print(img_path)
            prediction, image = detect_object(yolo, img_path, save_img=save_img, save_img_path=FLAGS.output,
        ...
        print("Processed {} images in {:.1f}sec - {:.1f}FPS".format(len(input_image_paths), end - start,
