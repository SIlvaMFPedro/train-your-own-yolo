# ===============================
# YOLO V2 MODEL DEFINED IN KERAS
# ===============================
...
from yad2k.models.keras_darknet import DarknetConv2D, DarknetConv2D_BN_Leaky, darknet_body
...
def space_to_depth_x2_output_shape(input_shape):
    ...
    """
    return (input_shape[0], input_shape[1] // 2, input_shape[2] // 2, 4 * input_shape[3]) if input_shape[1] \
...
def yolo_body(inputs, num_anchors, num_classes):
    ...
    conv21_reshaped = Lambda(space_to_depth_x2, output_shape=space_to_depth_x2_output_shape,
...
def yolo_head(feats, anchors, num_classes):
    ...
    Args:
        ...
        - anchors: (array-like) Anchor box width and heights;
    ...
    # TODO: Repeat elements and tf-split doesn't support dynamic splits
...
def yolo(inputs, anchors, num_classes):
    """
        Generate a complete YOLO localization model
    """
    num_anchors = len(anchors)
...
def yolo_filter_boxes(boxes, box_confidence, box_class_probs, threshold=.6):
    """
        Filter YOLO boxes based on the object and class confidence
    """
...
def preprocess_true_boxes(true_boxes, anchors, image_size):
    ...
    for box in true_boxes:
        ...
        if best_iou > 0:
            ...
            adjusted_box = np.array([box[0] - j, box[1] - i, np.log(box[2] / anchors[best_anchor][0]),
                                     np.log(box[3] / anchors[best_anchor][1]), box_class], dtype=np.float32)
