# =======================================================
# DRAW PREDICTED OR GROUND TRUTH BOXES ON THE INPUT IMAGE
# =======================================================
...
def get_colors_for_classes(num_classes):
    """
        Return the list of random colors for number of classes given;
    """
    ...
    # Fix seed for consistent colors across runs.
    random.seed(10101)
...
def draw_boxes(image, boxes, box_classes, class_names, scores=None):
    """
        ...
        Draw bounding boxes with class name and optional box score on the input image;
    Args:
    ...
    Returns:
        - Image copy modified with the given bounding boxes
    """
