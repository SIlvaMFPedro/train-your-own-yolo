...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch", type=str, 
                        help="Image detection mode for each file specified in input txt, "
                             "will ignore all positional arguments")
    parser.add_argument("--confidence", type=float, dest="score", default=0.3, 
                        help="Model confidence threshold above which to show predictions")
    parser.add_argument("--iou_min", type=float, dest="iou_thr", default=0.45, 
                        help="IoU threshold for pruning object candidates with higher IoU than higher score boxes")
    parser.add_argument("--input", nargs="?", type=str, required=False, default="input", 
