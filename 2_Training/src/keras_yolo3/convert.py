# =========================================================================
#  READ DARKNET CONFIG AND WEIGHTS AND CREATES KERAS MODEL WITH TF BACKEND
# =========================================================================
...
def main(args):
    ...
    for section in cfg_parser.sections():
        ...
        if section.startswith("convolutional"):
            ...
            conv_layer = (Conv2D(filters, (size, size), strides=(stride, stride), kernel_regularizer=l2(weight_decay),
                                 use_bias=not batch_normalize, weights=conv_weights, activation=act_fn, padding=padding)
                          )(prev_layer)
            if batch_normalize:
    ...
    weights_file.close()
    print(f"Read {count:0.0f} of {count + remaining_weights:0.0f} from Darknet weights.")
