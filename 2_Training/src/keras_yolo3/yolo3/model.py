...
def DarknetConv2D(*args, **kwargs):
    """
        Wrapper to set Darknet parameters to Convolution2D format.
        :param args:
        :param kwargs:
        :return:
    """
...
def make_last_layers(x, num_filters, out_filters):
    ...
    """
    x = compose(DarknetConv2D_BN_Leaky(num_filters, (1, 1)), DarknetConv2D_BN_Leaky(num_filters * 2, (3, 3)),
                DarknetConv2D_BN_Leaky(num_filters, (1, 1)), DarknetConv2D_BN_Leaky(num_filters * 2, (3, 3)),
...
def yolo_body(inputs, num_anchors, num_classes):
    """
        Create YOLO V3 model CNN body in Keras
        :param inputs:
        :param num_anchors:
        :param num_classes:
        :return:
...
def tiny_yolo_body(inputs, num_anchors, num_classes):
    """
        ...
        :return:
    """
    x1 = compose(DarknetConv2D_BN_Leaky(16, (3, 3)), MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="same"),
                 DarknetConv2D_BN_Leaky(32, (3, 3)), MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="same"),
                 DarknetConv2D_BN_Leaky(64, (3, 3)), MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="same"),
                 DarknetConv2D_BN_Leaky(128, (3, 3)), MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="same"),
                 DarknetConv2D_BN_Leaky(256, (3, 3)))(inputs)
    x2 = compose(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="same"), DarknetConv2D_BN_Leaky(512, (3, 3)),
                 MaxPooling2D(pool_size=(2, 2), strides=(1, 1), padding="same"), DarknetConv2D_BN_Leaky(1024, (3, 3)),
